...
def creator():
    ...
    start_inst1 = large_font.render("Vaibhav Borse(Patil)", False, GREEN)
    ...
    start_inst2 = small_font.render(
        "Hello guys, This is Vaibhav. Thanks for playing my game.", True, BLUE)
    start_inst3 = small_font.render(
        "This is a very simple game, developed using python", True, BLUE)
    start_inst4 = small_font.render(
        "In case of queries, write to vaibhavpatilme1117@gmail.com", True, BLUE)
